    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="small-box" style="background-color: #2e51fa; color: white;">
                ...
                <div class="col-lg-2 col-6">
                    <div class="small-box" style="background-color: #2e51fa; color: white;">
                        ...
                        <a href="/orcamentos" style="color: #fff" class="small-box-footer">Acessar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
