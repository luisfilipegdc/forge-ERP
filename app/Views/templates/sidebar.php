<head>
    <style>
        ...
        .img.brand-image {
        width: 250px; /* Altere a largura conforme necessário */
...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #141c33;">
<!-- Brand Logo -->
<a href="#" class="brand-link" style="text-align: center; font-weight: bold; padding: 4px;">
    <img src="/assets/img/logo-branca.png" alt="Logo" style="width: 100px; height: 40px; margin-bottom: 10px; margin-top:10px;">
</a>
